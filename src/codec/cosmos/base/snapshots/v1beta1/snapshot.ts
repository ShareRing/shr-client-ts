...
export const SnapshotItem = {
  ...
  toJSON(message: SnapshotItem): unknown {
    ...
    message.extensionPayload !== undefined &&
      (obj.extensionPayload = message.extensionPayload ? SnapshotExtensionPayload.toJSON(message.extensionPayload) : undefined);
  ...
  fromPartial<I extends Exact<DeepPartial<SnapshotItem>, I>>(object: I): SnapshotItem {
    ...
    message.extension =
      object.extension !== undefined && object.extension !== null ? SnapshotExtensionMeta.fromPartial(object.extension) : undefined;
