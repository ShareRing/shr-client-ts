...
import {Secp256k1HdWallet, extractKdfConfiguration} from "./hdwallet";
...
describe("Secp256k1HdWallet", () => {
  ...
  describe("signDirect", () => {
    it("resolves to valid signature", async () => {
      ...
      const signDoc = makeSignDoc(fromHex(bodyBytes), makeAuthInfoBytes([pubkey], fee, gasLimit, sequence), chainId, accountNumber);
