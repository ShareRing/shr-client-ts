...
export class Secp256k1Wallet implements OfflineDirectSigner {
   ...
   * @param prefix The bech32 address prefix (human readable part). Defaults to "shareledger".
   */
  public static async fromKey(privkey: Uint8Array, prefix = "shareledger"): Promise<Secp256k1Wallet> {
