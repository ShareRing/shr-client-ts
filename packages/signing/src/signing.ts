...
import {AuthInfo, SignDoc, SignerInfo} from "@shareledgerjs/types/cosmos/tx/v1beta1/tx";
 ...
 */
function makeSignerInfos(signers: ReadonlyArray<{readonly pubkey: Any; readonly sequence: number}>, signMode: SignMode): SignerInfo[] {
  return signers.map(
