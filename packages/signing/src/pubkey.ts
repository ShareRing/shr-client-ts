...
import {PubKey as Ed25519PubKey} from "@shareledgerjs/types/cosmos/crypto/ed25519/keys";
import {LegacyAminoPubKey} from "@shareledgerjs/types/cosmos/crypto/multisig/keys";
import {PubKey as Secp256k1PubKey} from "@shareledgerjs/types/cosmos/crypto/secp256k1/keys";
