...
import {
  ...
  MsgEditValidator,
  MsgUndelegate
} from "@shareledgerjs/types/cosmos/staking/v1beta1/tx";
...
export function createStakingAminoConverters(prefix: string): Record<string, AminoConverter | "not_supported_by_chain"> {
  return {
