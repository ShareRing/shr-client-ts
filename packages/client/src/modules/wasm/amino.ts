...
import {
  ...
  MsgStoreCode,
  MsgUpdateAdmin
} from "@shareledgerjs/types/cosmwasm/wasm/v1/tx";
import {AccessConfig} from "@shareledgerjs/types/cosmwasm/wasm/v1/types";
...
export function createWasmAminoConverters(): Record<string, AminoConverter | "not_supported_by_chain"> {
  return {
