...
import {AminoConverters, AminoTypes, makeSignDoc as makeSignDocAmino, StdFee} from "@shareledgerjs/amino";
import {
  EncodeObject,
  encodePubkey,
  GeneratedType,
...
import {Client, DeliverTxResponse} from "./client";
import {calculateFee, GasPrice} from "./fee";
import {createAuthTypes} from "./modules/auth";
import {createBankActions, createBankAminoConverters, createBankTypes} from "./modules/bank";
import {createDistributionActions, createDistributionAminoConverters, createDistributionTypes} from "./modules/distribution";
import {createGovActions, createGovAminoConverters, createGovTypes} from "./modules/gov";
import {createSlashingActions, createSlashingAminoConverters, createSlashingTypes} from "./modules/slashing";
import {createStakingActions, createStakingAminoConverters, createStakingTypes} from "./modules/staking";
...
export const defaultRegistryTypes: ReadonlyArray<[string, GeneratedType]> = [
  ...
  createSlashingTypes,
  createStakingTypes
].reduce<ReadonlyArray<[string, GeneratedType]>>((prev, curr) => [...prev, ...curr()], []);
